...
/**
 * ID: 464
 * 传送门: <a href="https://leetcode-cn.com/problems/can-i-win/" />
 *
 * @author wuzheng
...
public class 我能赢吗 {
    ...
    public static void main(String[] args) {
        System.out.println(new 我能赢吗().new Solution().canIWin(5, 7));
    }
    ...
    public class Solution {
        ...
        private boolean dfs(int maxChoosableInteger, int desiredTotal, int state, Boolean[] dp) {
            System.out.println(maxChoosableInteger + "," + desiredTotal + "," + state);
            ...
            for (int i = 1; i <= maxChoosableInteger; i++){
                 ...
                 */
                int tmp = (1 << (i - 1)); // tmp转换为二进制后，只有1位是1，用来标识当前待抉择的位
